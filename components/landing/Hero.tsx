...
export default function Hero() {
  ...
  const copy = {
    pt: {
      ...
      sub3: 'Para founders, líderes e profissionais de alta performance: a profundidade de uma avaliação baseada em instrumentos psicométricos validados internacionalmente pela fração do tempo e do custo.',
    ...
    en: {
      ...
      sub3: 'For founders, leaders and high-performance professionals: the depth of an evaluation based on internationally validated psychometric instruments at a fraction of the time and cost.',
